...
function assistantMsg(text) {
	return `<div class="bg-surface-primary flex flex-col overflow-hidden rounded-2xl px-4 py-3"><div class="prose"><p>${text}</p></div></div>`;
}
...
function sessionPage(sid) {
	...
	return page(conv.title, conversation(conv.pairs));
}
